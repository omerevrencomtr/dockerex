            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a href="{{route('index')}}" class="nav-link">
                        <i class="material-icons">dashboard</i> {{__('menu.home')}}
                    </a>
                </li>
                <li class="nav-item ">
...
<div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" style="background-image: url('{{asset('assets/img/bg-crypto.jpg')}}')">
        <div class="container">
            @yield('content')
        </div>
        <footer class="footer">
            <div class="container">
                ...
                <div class="copyright float-right">
                    ...
                    </script>, {{__('home.copyright')}} <a href="{{route('index')}}" target="_blank">{{config('app.name')}}</a>
                </div>
            </div>
        </footer>
    </div>
